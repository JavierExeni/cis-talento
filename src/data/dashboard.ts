...
export const ausentesHoy: AusenteHoy[] = activos.slice(8, 17).map((e, i) => ({
  ...
  avatar: e.avatar,
  motivo: ['Vacaciones', 'Vacaciones', 'Enfermedad', 'Permiso personal', 'Cumpleaños'][i % 5],
  pais: e.pais,
}))
...
export const recentActivity: Activity[] = [
  { id: 'a1', kind: 'permiso', texto: 'aprobó la solicitud de vacaciones de Sarah Mitchell', actor: 'Alex Carter', hace: 'hace 12 min' },
  { id: 'a2', kind: 'alta', texto: 'dio de alta a David Brooks como Asesor Comercial (BO)', actor: 'Analista de RR.HH.', hace: 'hace 1 h' },
  { id: 'a3', kind: 'reconocimiento', texto: 'recibió un reconocimiento', actor: 'Laura Bennett', hace: 'hace 2 h' },
  { id: 'a4', kind: 'okr', texto: 'actualizó el avance T2 del KR “Tools y plataformas”', actor: 'Mark Reynolds', hace: 'hace 3 h' },
