...
export const notifications: Notif[] = [
  ...
  { id: 'n2', kind: 'reconocimiento', titulo: 'Nueva estrella de valor', detalle: 'Camila Santiana reconoció tu apoyo en el cierre de mes.', hace: 'hace 40 min', unread: true },
  ...
  { id: 'n4', kind: 'okr', titulo: 'Avance T2 actualizado', detalle: 'Fabián actualizó “Tools y plataformas” al 100%.', hace: 'hace 3 h', unread: false },
  { id: 'n5', kind: 'cumple', titulo: '3 cumpleaños esta semana', detalle: 'Recuerda saludar a tu equipo 🎂', hace: 'hoy', unread: false },
  { id: 'n6', kind: 'sistema', titulo: 'Migración del HRM al 62%', detalle: '190 de 312 empleados ya migrados desde OrangeHRM.', hace: 'ayer', unread: false },
